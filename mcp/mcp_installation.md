...
Mở Terminal tại thư mục gốc của repo này (`prompt-library/`) và chạy:
```bash
...
```json
{
  "mcpServers": {
    "MasterPromptMemory": {
      ...
      "args": [
        "run",
        "/absolute/path/to/prompt-library/mcp/server.py"
      ]
    }
  }
}
...
3. Điền thông tin:
   ...
   - **Type**: `command`
   - **Command**: `fastmcp run /Users/djv033/Downloads/iOS_Post/prompt-library/mcp/server.py`
