...
```
mobile-kit/
├── CLAUDE.md                   # Project context & guardrails for Claude Code
├── claude-kit.config.yaml      # Mapping: agents, workflows, templates, commands
...
│       ├── MOBILE_CONTEXT.md
│       └── package.json
├── commands/                   # Claude commands (YAML prompts)
│   ├── new-project.yaml
