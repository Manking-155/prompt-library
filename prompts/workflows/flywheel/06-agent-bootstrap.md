...
category: planning
target: universal
tags: [agent, bootstrap, coordination, initialization, mcp]
created: 2026-04-13
updated: 2026-04-13
changelog:
  - "1.0: Initial version for agent bootstrap and MCP coordination."
---
...
Then register with MCP Agent Mail and introduce yourself to the other agents. Be sure to check your agent mail and to promptly respond if needed to any messages; then proceed meticulously with your next assigned beads, working on the tasks systematically and meticulously and tracking your progress via beads and agent mail messages. 
