...
Lưu file này dưới dạng `.claude/commands/architecture-pro.md`
...
cp architecture-pro.md .claude/commands/
```

2. Dùng command:
```bash
/architecture-pro "E-learning refactor: legacy PHP monolith sang microservices 100K user, tối ưu chi phí cloud"
/architecture-pro "IoT platform for smart city: 50K thiết bị, near-real-time, data analytics và alerting"
```

3. Output sẽ tự động gồm:
