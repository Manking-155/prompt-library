# Create agent definition example
agent_definition = """# Mobile UI/UX Designer Agent
...
with open('mobile-ui-ux-designer-agent.md', 'w', encoding='utf-8') as f:
    f.write(agent_definition)

print("✅ Created mobile UI/UX designer agent definition")